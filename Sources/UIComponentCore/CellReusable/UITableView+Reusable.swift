...
extension UITableView {
    ...
    public final func dequeueReusableCell<T: UITableViewCell>(
    ...
    where T: Reusable {
        ...
        guard
            let cell = self.dequeueReusableCell(
                withIdentifier: cellType.reuseIdentifier, for: indexPath) as? T
        else {
            fatalError(
    ...
    public final func dequeueCellReusableHeaderFooterView<T: UITableViewHeaderFooterView>(
        _ viewType: T.Type = T.self
    ) -> T?
    where T: Reusable {
        guard
            let view = self.dequeueReusableHeaderFooterView(
