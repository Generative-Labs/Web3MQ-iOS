...
public class ChatsListTableViewCell: ChatsItemTableViewCell {
    ...
    public override func render(chatItem: ChannelItem) {
        ...
        case .topic:
            avatarImageView.kf.setImage(with: chatItem.avatarURL,
                                        placeholder: UIImage(systemName: "ellipsis.vertical.bubble"), options: [.processor(RoundCornerImageProcessor(radius: Radius.point(0.1)))])
        case .user:
            avatarImageView.kf.setImage(with: chatItem.avatarURL,
                                        placeholder: UIImage(systemName: "person.circle.fill"), options: [.processor(RoundCornerImageProcessor(radius: Radius.point(0.5)))])
        case .group:
            avatarImageView.kf.setImage(with: chatItem.avatarURL,
                                        placeholder: UIImage(systemName: "person.3.fill"), options: [.processor(RoundCornerImageProcessor(radius: Radius.point(0.1)))])
        }
