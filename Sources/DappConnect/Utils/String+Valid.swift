...
extension String {
    ...
    static func conformsToCAIP2(_ string: String) -> Bool {
        ...
        let isNamespaceValid =
            (namespace.range(of: chainNamespaceRegex, options: .regularExpression) != nil)
        let isReferenceValid =
            (reference.range(of: chainReferenceRegex, options: .regularExpression) != nil)
    ...
    static func conformsToCAIP10(_ string: String) -> Bool {
        ...
        let isReferenceValid =
            (reference.range(of: chainReferenceRegex, options: .regularExpression) != nil)
        let isAddressValid =
            (address.range(of: accountAddressRegex, options: .regularExpression) != nil)
